<?php
namespace RindowTest\NeuralNetworks\Layer\GlobalAveragePooling3DTest;
...
class Test extends TestCase
{
    ...
    public function testUnmatchSpecifiedInputShape()
    {
        ...
        $this->expectExceptionMessage('Input shape is inconsistent: defined as [4,4,4,3] but [4,4,4,5] given in GlobalAveragePooling3D');
        $layer->build($inputs);
    }
