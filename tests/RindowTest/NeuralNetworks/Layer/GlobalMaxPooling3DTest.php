<?php
namespace RindowTest\NeuralNetworks\Layer\GlobalMaxPooling3DTest;
...
class GlobalMaxPooling3DTest extends TestCase
{
    ...
    public function testUnmatchSpecifiedInputShape()
    {
        ...
        $this->expectExceptionMessage('unmatch input shape: (4,4,4,5), must be (4,4,4,3) in globalmaxpooling3d');
