<?php
namespace RindowTest\NeuralNetworks\Layer\GlobalAveragePooling2DTest;
...
class GlobalAveragePooling2DTest extends TestCase
{
    ...
    public function testUnmatchSpecifiedInputShape()
    {
        ...
        $this->expectExceptionMessage('unmatch input shape: (4,4,5), must be (4,4,3) in globalaveragepooling2d');
