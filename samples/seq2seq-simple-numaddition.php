...
{
    public function __construct($mo,int $corpus_max,int $digits,bool $reverse=true)
    {
        $this->mo = $mo;
...
$dataset = new NumAdditionDataset($mo,$TRAINING_SIZE,$DIGITS,$REVERSE);
...
for($i=0;$i<10;$i++) {
    ...
    if($REVERSE)
        $question_str = strrev($question_str);
